...
{{-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">DL Metais</a>
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item {{ Request::is('representantes') ? 'active' : '' }}" >
        <a class="nav-link" href="{{ route('representantes.index') }}">Representantes</a>
      </li>
      <li class="nav-item {{ Request::is('clientes') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('clientes.index') }}">Clientes</a>
      </li>
      <li class="nav-item {{ Request::is('parceiros') ? 'active' : '' }}">
