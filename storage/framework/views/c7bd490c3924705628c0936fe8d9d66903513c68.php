        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <?php if($cliente->cep): ?>
                        <td><?php echo e($cliente->bairro); ?>, <?php echo e($cliente->logradouro); ?>, <?php echo e($cliente->numero); ?> - <?php echo e($cliente->complemento); ?></td>
                    <?php else: ?>
                        <td></td>
                    <?php endif; ?>
                    
                    <td><?php echo e($cliente->celular); ?> <?php echo e($cliente->telefone); ?></td>
                </tr>
